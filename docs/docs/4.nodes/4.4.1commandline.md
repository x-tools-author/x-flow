...
假如输入数据为`hello world`，其对应的16进制（大写）为`68656C6C6F20776F726C64`，勾选`输入数据转换为16进制字符作为参数`则命令行的参数为：

```bat
python text.py 68656C6C6F20776F726C64
```

则输出结果为：`"68656C6C6F20776F726C64"`

假如输入数据为`hello world`，其对应的16进制（大写）为`68656C6C6F20776F726C64`，勾选`输入数据转换为UTF8文本作为参数`则命令行的参数为：
