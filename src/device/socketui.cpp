    ...
    , ui(new Ui::SocketUi)
{
    ...
    connect(ui->comboBoxServerIp, xComboBoxActivated, this, &SocketUi::parametersChanged);
    connect(ui->spinBoxServerPort, &QSpinBox::valueChanged, this, &SocketUi::parametersChanged);
    connect(ui->checkBoxAuthentication, &QCheckBox::clicked, this, &SocketUi::parametersChanged);
    connect(ui->lineEditUser, &QLineEdit::textEdited, this, &SocketUi::parametersChanged);
    connect(ui->lineEditPassword, &QLineEdit::textEdited, this, &SocketUi::parametersChanged);
    connect(ui->lineEditMulticastIp, &QLineEdit::textEdited, this, &SocketUi::parametersChanged);
    connect(ui->spinBoxMulticastPort, &QSpinBox::valueChanged, this, &SocketUi::parametersChanged);
    connect(ui->checkBoxEnableMulticast, &QCheckBox::clicked, this, &SocketUi::parametersChanged);
    connect(ui->checkBoxJustMulticast, &QCheckBox::clicked, this, &SocketUi::parametersChanged);
}

SocketUi::~SocketUi() {}

QJsonObject SocketUi::save() const
{
    SocketItem item;
...
void SocketUi::load(const QJsonObject &parameters)
{
